...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-3rfhe21817381_api1.business.example.com";
    private string APIPassword = "NXK9HU9Q944LKLZT";
    private string APISignature = "A.94ZlAIz6oS.UN7ANNSoYwJQ3iMAE9yMI8-M4.3F5bauJo8OZhy404F";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44383/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44383/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "La Boulangerie Sample Application";
        ...
        using (LaBoulangerie.Logic.ShoppingCartActions myCartOrders = new LaBoulangerie.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            LaBoulangerie.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
